    ...
    def callback(self, data):
       ...
       # Convert the received image into a opencv image
        ...
        if len(contours) > 0:
            ...
            if cv2.contourArea(c) > 1900: #<What do you think is a suitable area?>
                ...
                colour = (190,255,24)
                thickness = 2
                cv2.circle(filtered_img,(center_x,center_y),radius,colour,thickness)
        ...
        # create a ROS String object (the message we will publish).
        msg = String()
        # populate the message’s data property with the f-string: “ {self.greenfound}”.
        msg.data = f'{self.greenfound}'
        # publish the message to the topic (i.e. chatter).
